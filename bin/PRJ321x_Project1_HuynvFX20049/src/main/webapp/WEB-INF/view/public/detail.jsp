  ...
  <header class="site-navbar mt-3">
    <div class="container-fluid">
      <div class="row align-items-center">
        ...
        <div class="right-cta-menu text-right d-flex aligin-items-center col-4">
          <div class="ml-auto">
...
<!--            <h3 class="mb-5" th:text="${userDonationList.size()}+${'  donation'}"> </h3>-->
            <ul class="comment-list">
           		<c:forEach var="tempUserDonation" items="${userDonationsAccepted}">
                <li class="comment">
                  <div class="vcard bio">
                  ...
                  <div class="comment-body">
                    <h3>${tempUserDonation.name}</h3>
                    <div class="meta" style="color: #373b3e !important;">${tempUserDonation.created}</div>
                    <p>${tempUserDonation.money} VNĐ</p>
                  </div>
                </li>
				</c:forEach>
            </ul>
        ...
        <div class="col-lg-6">
          <div class="bg-light p-3 border rounded mb-4">
            ...
            <ul class="list-unstyled pl-3 mb-0">
              ...
              <li class="mb-2"><strong class="text-black">Tổng tiền quyên góp nhận được: </strong>${sumMoneyUserDonation}</li>
			...
			<c:choose>
				<c:when test="${donation.status == 2 and loggedinUser != null}">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form:form method="post" modelAttribute="userDonation" action="saveUserDonation">
